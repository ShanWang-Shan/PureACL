...
with open(txt_file_name, "r") as txt_f:
    ...
    for line in lines:
        ...
        imu2ENU = Pose.from_4x4mat(euler_matrix(roll, pitch, heading))
...
Min_Pose = 0
Max_Pose = -1
plt.plot(gt_enu[Min_Pose:Max_Pose, 0], gt_enu[Min_Pose:Max_Pose, 1], color='r', marker='o', markersize=2) #linewidth=1)
plt.plot(shift_enu[Min_Pose:Max_Pose, 0], shift_enu[Min_Pose:Max_Pose, 1], color='b', marker='o', markersize=2)# linewidth=1)
